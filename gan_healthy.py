...
gz_path = '/content/drive/My Drive/pcamv1/camelyonpatch_level_2_split_train_y.h5.gz'

# Decompressed output file
output_path = '/content/camelyonpatch_level_2_split_train_y.h5'
...
# Output folder
output_dir = '/content/healthy_images'
...
gen.load_state_dict(torch.load('/content/best_generator_healthy.pth', map_location=device))
disc.load_state_dict(torch.load('/content/best_discriminator_healthy.pth', map_location=device))
